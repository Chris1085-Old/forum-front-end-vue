        ...
        <tr v-for="(user, index) in users" :key="user.id">
          ...
          <td>
            <button
              ...
              @click.stop.prevent="user.isAdmin = !user.isAdmin"
            >
...
const dummyData = {
  users: [
    ...
    },
    {
      ...
      password: '$2a$10$c7SAr4qy/bS3wLnmGRC0xeKcgWe5ke7o7MCIOiVNJiHeXTVXzWQc6',
      isAdmin: false,
      image: null,
      createdAt: '2021-06-30T10:09:01.000Z',
      updatedAt: '2021-06-30T10:09:01.000Z'
    },
    {
      ...
      password: '$2a$10$.3y3twth.50DSYJ/LS2/9O9jN/ZThph/UlaExrif6hAghwsq93QV6',
      isAdmin: false,
      image: null,
